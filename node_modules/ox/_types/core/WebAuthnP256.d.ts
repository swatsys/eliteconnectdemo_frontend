...
export declare namespace createCredential {
    var parseError: (error: unknown) => createCredential.ErrorType;
}
export declare namespace createCredential {
...
export declare namespace getAuthenticatorData {
    var parseError: (error: unknown) => getAuthenticatorData.ErrorType;
}
export declare namespace getAuthenticatorData {
    type Options = {
...
export declare namespace getClientDataJSON {
    var parseError: (error: unknown) => getClientDataJSON.ErrorType;
}
export declare namespace getClientDataJSON {
    type Options = {
...
export declare namespace getCredentialCreationOptions {
    var parseError: (error: unknown) => getCredentialCreationOptions.ErrorType;
}
export declare namespace getCredentialCreationOptions {
    type Options = {
        /**
...
export declare namespace getCredentialRequestOptions {
    var parseError: (error: unknown) => getCredentialRequestOptions.ErrorType;
}
export declare namespace getCredentialRequestOptions {
    type Options = {
...
export declare namespace sign {
    var parseError: (error: unknown) => sign.ErrorType;
}
export declare namespace sign {
...
export declare namespace verify {
    var parseError: (error: unknown) => verify.ErrorType;
}
export declare namespace verify {
    type Options = {
