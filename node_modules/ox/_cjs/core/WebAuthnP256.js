...
createCredential.parseError = (error) => error;
...
getAuthenticatorData.parseError = (error) => error;
...
getClientDataJSON.parseError = (error) => error;
...
getCredentialCreationOptions.parseError = (error) => error;
...
getSignPayload.parseError = (error) => error;
